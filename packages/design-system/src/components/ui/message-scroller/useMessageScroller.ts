...
function getMessageChildren(content: HTMLElement, _spacer: HTMLElement | null): HTMLElement[] {
  return Array.from(content.querySelectorAll<HTMLElement>('[data-slot="message-scroller-item"]'));
}
