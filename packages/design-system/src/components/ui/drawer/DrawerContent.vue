    ...
    <DrawerContent
      ...
      :class="
        cn(
          ...
          'data-[swipe-direction=down]:data-[state=closed]:slide-out-to-bottom data-[swipe-direction=down]:data-[state=open]:slide-in-from-bottom',
          'data-[swipe-direction=up]:data-[state=closed]:slide-out-to-top data-[swipe-direction=up]:data-[state=open]:slide-in-from-top',
          'data-[swipe-direction=left]:data-[state=closed]:slide-out-to-left data-[swipe-direction=left]:data-[state=open]:slide-in-from-left',
          'data-[swipe-direction=right]:data-[state=closed]:slide-out-to-right data-[swipe-direction=right]:data-[state=open]:slide-in-from-right',
          props.class,
        )
      "
    >
      <DrawerHandle
        class="mx-auto mt-4 hidden h-1 w-[100px] shrink-0 rounded-full bg-muted group-data-[swipe-direction=down]/drawer-content:block"
      />
      <slot />
    </DrawerContent>
  </DrawerPortal>
